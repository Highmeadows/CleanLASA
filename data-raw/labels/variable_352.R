...
standardized_value_labels <- list(
  mandia1 = c(`0` = "no", `1` = "yes"),
  mandia2 = c(`0` = "no", `1` = "yes"),
  mandiab = c(`0` = "no", `1` = "yes"),
  mbenanx = c(`0` = "no", `1` = "yes"),
  mbenhyp = c(`0` = "no", `1` = "yes"),
  med_ali = c(`0` = "no", `1` = "yes"),
  med_ang = c(`0` = "no", `1` = "yes"),
  med_ari = c(`0` = "no", `1` = "yes"),
  med_diu = c(`0` = "no", `1` = "yes"),
  med_hyp = c(`0` = "no", `1` = "yes"),
  med_ino = c(`0` = "no", `1` = "yes"),
  med_pvd = c(`0` = "no", `1` = "yes"),
  mmedad = c(`0` = "no", `1` = "yes"),
