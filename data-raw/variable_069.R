...
variable_labels(
  "cultdis1", "cultdis2", "cultdis3", "cultid1", "cultid2", "cultid3", "cultid4", "cultid5", "cultid6", "cultid7", "loss1", "loss2", "loss3", "loss4", "loss5", "loss6", "loss7", "nllang1", "nllang2", "nllang3",
...
value_labels(
  `-1` = "na, asked",
  .applies_to_vars = c("cultdis1", "cultdis2", "cultdis3", "cultid1", "cultid2", "cultid3", "cultid4", "cultid5", "cultid6", "cultid7", "loss1", "loss2", "loss3", "loss4", "loss5", "loss6", "loss7", "nllang1", "nllang2", "nllang3"),
  .applies_to_waves = c("Z", "MB")
)

value_labels(
  `1` = "strongly disagree", `2` = "disagree", `3` = "agree", `4` = "strongly agree",
  .applies_to_vars = c("cultdis1", "cultdis2", "cultdis3", "nllang1", "nllang2", "nllang3"),
  .applies_to_waves = c("Z", "MB")
)

value_labels(
  `1` = "never", `2` = "sometimes", `3` = "regularly", `4` = "often",
  .applies_to_vars = c("cultid1", "cultid2", "cultid3", "cultid4", "cultid5", "cultid6", "cultid7"),
  .applies_to_waves = c("Z", "MB")
)

value_labels(
  `1` = "no", `2` = "yes",
  .applies_to_vars = c("loss1", "loss2", "loss3", "loss4", "loss5", "loss6", "loss7"),
  .applies_to_waves = c("Z", "MB")
)

.lasa_fc_069 <- .lasa_finalize_fc("069")
